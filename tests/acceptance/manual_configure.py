...
client.create_account('student3')
client.establish_ssh_keys('student3')
client.create_git_config('student3')
...
print('Students Clone and Submit Assignments')
...
client.clone_assignment('student2', 'prof1', 'cs1', 'good_simple')
client.student_submits('student2', 'prof1', 'cs1', 'good_simple', 'correct_solution')
client.clone_assignment('student3', 'prof1', 'cs1', 'good_simple')
client.student_submits('student3', 'prof1', 'cs1', 'good_simple', 'correct_solution')
