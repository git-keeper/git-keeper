...
The grader will not run your `main()` method but will instead run some tests against your `Histogram` class to make sure it works properly. For this assignment you will not be penalized if you don't pass the tests on the first try.
